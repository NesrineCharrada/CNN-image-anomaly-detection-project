...
This project demonstrates how to build and train a **deep learning model** to classify **chest X-ray images** into three categories: **Normal**, **Viral Pneumonia**, and **COVID-19**.  
It was created as part of the **Coursera Guided Project: “Detecting COVID-19 with Chest X-Ray using PyTorch”**.
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/<your-username>/CNN-image-anomaly-detection-project.git
